    ...
    <section class="page-title-one">
        <div class="auto-container">
            <div class="page-title-one-content">
                ...
                <div class="page-title-one-desc">Avis de clients</div>
        ...
        <div class="auto-container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="testimonial-one-slider-item mb-30">
                        <div class="testimonial-one-text"> beau cadre <br> un jolie endroit <br> service impécable <br> prsonnel pro<br> lieu acceuillant </div>
                        ...
                        <div class="testimonial-one-author-info">
                            ...
                            <div class="testimonial-one-author-name">Sminth</div>
                            <div class="testimonial-one-designation">Codeur</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
