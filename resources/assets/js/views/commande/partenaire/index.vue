<template>
  <el-card style="width: 100%">
    ...
    <div class="mt-2">
      <div class="row">
        <div class="col-sm-12">
          <el-table ref="table" v-loading="isRequestOngoing" :data="usrData" stripe border fit
                    style="width: 100%">
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      const response = await this.FETCH_COMMANDES(data_filters)
      if (response.data) {
